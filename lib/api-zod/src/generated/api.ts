  ...
  investmentForm: zod
    .object({
      ...
      departmentOther: zod
        ...
        .nullish()
        .describe(
          "Free-text department when the controlled department choice is Autre\/Other.",
        ),
      ...
      valueTier: zod.string().nullish(),
      tier2Choice: zod.string().nullish(),
      livreIExceptionItem: zod.string().nullish(),
      livreIIExceptionItem: zod.string().nullish(),
 ...
 */
export const ValidateAccordPrincipeParams = zod.object({
  id: zod.coerce.number(),
});

export const ValidateAccordPrincipeBody = zod.object({
  comment: zod.string().nullish(),
});

export const ValidateAccordPrincipeResponse = zod.object({
  id: zod.number(),
  reference: zod.string(),
  title: zod.string(),
  departmentId: zod.number(),
 ...
 */
export const UpdateInitialWorkflowRequestParams = zod.object({
  id: zod.coerce.number(),
});

export const UpdateInitialWorkflowRequestBody = zod
  .object({
    title: zod.string().nullish(),
...
export const UpdateInitialWorkflowRequestResponse = zod.object({
  id: zod.number(),
  reference: zod.string(),
  title: zod.string(),
  departmentId: zod.number(),
 ...
 */
export const UploadInitialRequestDocumentParams = zod.object({
  id: zod.coerce.number(),
});

export const UploadInitialRequestDocumentBody = zod.object({
  file: zod.instanceof(File),
  step: zod.enum(["DRAFT", "NEW", "QUOTATION"]),
  kind: zod.enum(["QUOTE", "OTHER"]),
});
