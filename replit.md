...
When changing the application version, update both the package version
declarations and the user-visible `APP_VERSION` in
`artifacts/purchasing-management/src/components/AppShell.tsx`.
